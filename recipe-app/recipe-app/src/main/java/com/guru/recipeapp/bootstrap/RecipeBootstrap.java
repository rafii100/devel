...
public class RecipeBootstrap {
	...
	@PostConstruct
	public void init() {
		System.out.println("BOOTSTRAP RECIPE");
	...
	public List<Recipe> getRecipes() {
		...
		Ingredient i1 = new Ingredient(uomRepository.findById(1L).get(), "Description ingredient 1", BigDecimal.valueOf(1),r);	
		Ingredient i2 = new Ingredient(uomRepository.findById(2L).get(), "Description ingredient 2", BigDecimal.valueOf(2),r);
		...
		Ingredient i3 = new Ingredient(uomRepository.findById(3L).get(), "Description ingredient 3", BigDecimal.valueOf(3), r2);
